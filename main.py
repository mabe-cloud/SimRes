...
p.maps_plot(time_list=p3_implicita.time_list, t_selected=t_list, x_pos=p3_implicita.L_list,p_an=p_an_1.pressures, p_explicit=p1_explicita.pressures, p_implicit=p3_implicita.pressures, p_an_times=p_an_3.time_list)

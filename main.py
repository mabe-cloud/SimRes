...
# t_list = [1, 20,50]
# p.maps_plot(time_list=p1_implicita.time_list, t_selected=t_list, x_pos=p1_implicita.L_list,p_an=p_an_1.pressures, p_explicit=p1_explicita.pressures, p_implicit=p1_implicita.pressures, p_an_times=p_an_1.time_list)
...
for Nt in NTs:
    ...
    for Nx in NXs:
        ...
        p1_implicita.run()
        p1_implicita.compute_error(p_an_1, times_to_compute_err=[10])
...
t_list = [1, 20,40]
p.maps_plot(time_list=p2_implicita.time_list, t_selected=t_list, x_pos=p2_implicita.L_list,p_an=p_an_2.pressures, p_explicit=p2_explicita.pressures, p_implicit=p2_implicita.pressures, p_an_times=p_an_2.time_list)
...
for Nt in NTs:
    ...
    for Nx in NXs:
        ...
        p3_implicita.run()
        p3_implicita.compute_error(p_an_3, times_to_compute_err=[10])

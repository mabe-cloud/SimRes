...
p.plot_p(L = Numerico1_implicita.L_list, Pressures = Numerico1_implicita.pressures, time_list=Numerico1_implicita.time_list, title = 'Método Explícito', times_to_plot = tempos, pos_to_plot = x, units = 'SI')
